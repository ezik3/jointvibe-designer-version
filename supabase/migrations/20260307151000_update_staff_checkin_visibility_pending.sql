-- Update staff approval check-in flow to initialize visibility as private + pending.
-- User then confirms public/private in-app; timeout defaults to private.
...
BEGIN
  ...
  -- Keep legacy param for compatibility with existing callers.
